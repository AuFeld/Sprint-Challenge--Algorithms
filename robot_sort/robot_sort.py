class SortingRobot:
    ...
    def sort(self):
        ...
        while self.can_move_right():
            # robot pick up item, leaves empty space behind
            self.swap_item()

            # robot moves to the right until it arrrives at the end of the list
            # robot compares items after each move to the right
            # robot swaps if item in hand is greater than item in front
            while self.can_move_right():
                self.move_right()
                if self.compare_item() is 1:
                    self.swap_item()
            
            # robot arrived at the end of the list
        ...
        # robot is done sorting, so we can turn the light off
        self.set_light_off()
